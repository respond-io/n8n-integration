...
const ACTION_SETTINGS = {
  ...
  [OPERATION_NAMES.CLOSING_NOTES]: {
    [ACTION_NAMES.GET_ALL_CLOSING_NOTES]: closingNotesActions.GET_ALL_CLOSING_NOTES,
  },
  ...
  [OPERATION_NAMES.CONVERSATIONS]: {
    [ACTION_NAMES.ASSIGN_OR_UNASSIGNED_CONVERSATION]:
      conversationsActions.ASSIGN_OR_UNASSIGNED_CONVERSATION,
